          ...
          <div class="middle-l" ref="middleL">
            <div class="cd-wrapper" ref="cdWrapper">
              <div class="cd" ref="imageWrapper">
                <img ref="image" class="image" :class="cdClass" :src="currentSong.image">
              </div>
            </div>
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <progress-bar ref="progressBar" :percent="percent"
                            @percentChanging="onPercentChanging"
      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <div class="imgWrapper" ref="miniWrapper">
            <img ref="miniImage" width="40" height="40" :class="cdClass" :src="currentSong.image">
          </div>
        </div>
        <div class="text">
...
//        this.songReady = false
      ...
      getLyric() {
        this.currentSong.getLyric().then((lyric) => {
          if (this.currentSong.lyric !== lyric) {  // 防止歌词多次渲染
            return
          }
      ...
      middleTouchMove(e) {
        ...
        if (Math.abs(deltaY) > Math.abs(deltaX)) {  // 纵轴绝对值大于横向偏差绝对值 什么也不动
          return
        }
        if (!this.touch.moved) {
